...
(function ($) {
    ...
    Neela = {
        ...
        objEvents: function () {
            ...
            $(".map-wrapper").on("mouseenter", function () {
                $(this).parent().find(".location-info").addClass("open");
            }).on("mouseleave", function () {
                $(this).parent().find(".location-info").removeClass("open");
            });
    ...
    -------------------------------------------*/
    // if ($("#clock").length) {
    //     $('#clock').countdown('2023-07-20 12:00', function(event) {
    //         var $this = $(this).html(event.strftime(''
    //             + '<div><div class="box"><div class="time">%D</div> <span>dny</span> </div>'
    //             + '<div class="box"><div class="time">%H</div> <span>hodiny</span> </div></div>'
    //             + '<div><div class="box"><div class="time">%M</div> <span>minuty</span> </div>'
    //             + '<div class="box"><div class="time">%S</div> <span>sekundy</span></div></div>'));
    //     });
    // }
